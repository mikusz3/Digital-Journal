...
contextBridge.exposeInMainWorld('bujo', {
  ...Object.fromEntries(['saveTask','toggleTask','deleteTask','preferences','savePreferences','setKey','generateAI','cancelAI','wallpaper'].map(action => [action, input => ipcRenderer.invoke('bujo', action, input)])),
