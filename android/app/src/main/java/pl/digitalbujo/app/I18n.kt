...
object I18n {
    ...
    fun save(context:Context,code:String){require(languages(context).has(code));context.getSharedPreferences("language",Context.MODE_PRIVATE).edit().putString("code",code).apply()}
